            ...
            <div class="col-lg-12 mb-4 order-0">
                <div class="card">
                    <div class="d-flex align-items-end row">
                        <div class="col-sm-7">
                            <div class="card-body">
                                <h5 class="card-title text-primary">Selamat Datang di Sistem Keuangan Erlina Konveksi 🎉</h5>
                                <p class="mb-4">
                                    Sistem ini membantu pengelolaan dan pemantauan keuangan Anda dengan lebih praktis.
                                </p>
                                    ...
                                    <div class="d-flex align-items-start justify-content-between mb-4">
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="cardOpt4">
                                                <li><a class="dropdown-item" href="/pendapatan">Lihat detail</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                    <!-- Content -->
                ...
                <div class="card h-100">
                    ...
                    <div class="card-body">
                        <ul class="p-0 m-0">
                            <li class="d-flex mb-4 pb-1">
                                <div class="avatar flex-shrink-0 me-3">
                                    <img src="{{ asset('/backend/assets/assets/img/icons/unicons/paypal.png') }}"
