...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold d-flex align-items-center my-4">
            ...
            <span class="text-muted fw-light me-1"></span> Pengeluaran
        </h4>
        <div class="card">
            <div class="d-flex align-items-center justify-content-between border-bottom pb-2 mb-3">
                <a class="mx-4 my-4" href="{{ route('pengeluaran.index') }}">
            ...
            <div class="card-body">
                <div class="text-nowrap">
                    ...
                    @endif
                    <form action="{{ url('pengeluaran-edit/' . $pengeluarans->id) }}" method="post"
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="jumlah" class="form-control" id="jumlah"
                                        placeholder="Rp." value="{{ number_format($pengeluarans->jumlah, 0, ',', '.') }}"
                                        oninput="formatRupiah(this)">
                                </div>
                                <div class="mb-3">
                                    <label for="bukti_pengeluaran" class="form-label">Bukti Transaksi</label>
                            ...
                            <div class="col-12">
                                <div class="row justify-content-center">
                                    ...
                                    @if ($pengeluarans->bukti_pengeluaran)
                                        <img id="previewGallerypendapatan"
                                            src="{{ asset('storage/' . $pengeluarans->bukti_pengeluaran) }}"
